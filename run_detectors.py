...
if __name__ == '__main__':
    ...
    from classifier.arf.core import *
    from classifier.arf.generics import describe
    import classifier.arf.monitor
    ...
    for FOLD in folds:
        ...
        monitor = classifier.arf.monitor.Monitor(model, holdout_batch, validation_batch, RUN, FOLD)
